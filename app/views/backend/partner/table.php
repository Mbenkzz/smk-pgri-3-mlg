<div class="d-flex flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	...
	<div class="btn-toolbar mb-2 mb-md-0 ml-2">
		<div class="btn-group mr-2">
			<a class="btn btn-sm btn-outline-success" href="<?= BASE_URL ?>admin-ea/partner/add">Add Partner</a>
		</div>
	</div>
	<div class="form-group search">
		<input type="text" class="form-control form-control-sm" id="searchPartner" onkeyup="render()" placeholder="Search...">
	</div>
</div>
<div class="row">
...
<div class="table-responsive">
	<table class="table table-striped table-sm" id="table_partner">
		<thead>
			<tr>
				<th>No<span></span></th>
				<th width="10%">Logo</th>
				<th width="20%" onclick="sort_column(this, 'partner_name')">Nama<span><i class="fa fa-sort"></i></span></th>
				<th width="25%">Detail Info</th>
	...
	<ul class="pagination justify-content-end" id="pagination_partner" style="margin:20px 0"></ul>
</div>
<script type="text/javascript">
	...
	function render(page = 1, sort = "") {
		...
		$.ajax({
			url: '<?= BASE_URL ?>admin-ea/partner/table',
			type: "get",
			data: {
				search: $("#searchPartner").val(),
				page: page,
			...
			success: function(response) {
				...
				var $tbody = $("#table_partner").find('tbody');
				var $pagination = $("#pagination_partner");
				$tbody.html("");
